from bwell.db.models import Order
from bwell.forms.base import Form
from bwell.forms.fields import *
...
class OrderFilterForm(Form):
    ...
    def is_valid(self) -> bool:
        is_valid = super().is_valid
        if not self.is_received and (
            self.receive_date_min or self.receive_date_max
        ):
            flash_error(
